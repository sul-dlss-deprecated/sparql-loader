...
# }""", 'content_type': 'application/sparql-update'}, "TEST")['statusCode'] == 200
...
def test_formatMessage():
    test_cases = [
        {
            ...
            "file": "etl_orgs.txt",
            "out": """['http://sul.stanford.edu/rialto/agents/orgs/vice-provost-for-student-affairs/dean-of-educational-resources/office-of-accessible-education/oae-operations',
        ...
        },
        {
            ...
            "out": """['http://sul.stanford.edu/rialto/context/names/75872',
        ...
        #     "out": """['http://sul.stanford.edu/rialto/context/addresses/2b3d13e9-4cea-49a5-ac73-34c603461ab1_WOS:000347715900024',
    ...
    for test_case in test_cases:
        ...
        assert handler.formatMessage(data) == "{'Action': 'touch', 'Entities': %s}" % ' '.join(test_case['out'].replace("\n", " ").split())
